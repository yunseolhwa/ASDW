...
- Name: ASDW
- Root: the current checkout or Codex worktree directory
...
This creates `.venv-win` in the current checkout when it is missing, checks
Python virtual environment dependencies, and compiles the core Python modules.
